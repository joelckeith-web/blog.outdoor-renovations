        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              {/* Facebook */}
              <a
                href="https://www.facebook.com/outdoorrenovations"
              ...
              {/* Instagram */}
              <a
                href="https://www.instagram.com/outdoorrenoatx/"
                className="text-gray-400 hover:text-brand-accent transition-colors"
              ...
              {/* Google Maps */}
              <a
                href="https://www.google.com/maps/place/Outdoor+Renovations"
                className="text-gray-400 hover:text-brand-accent transition-colors"
          ...
          <div>
            ...
            <ul className="space-y-2">
              {serviceAreaCities.map((area) => (
                <li key={area.slug} className="text-gray-300 text-sm">
                  {area.name}, TX
                </li>
              ))}
            </ul>
